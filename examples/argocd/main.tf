...
module "nginx-ingress" {
  ...
  conf = {
    ...
    "controller.service.annotations.service\\.beta\\.kubernetes\\.io/aws-load-balancer-ssl-cert"         = "arn:aws:acm:eu-north-1:641456973426:certificate/595ae84a-0019-43ff-b540-d2af938fd523" #module.clusterwide.this_acm_certificate_arn
